...
class advancedwordpressconfigurationpluginBackendOptions {
	...
	function addSettingsGeneral() {
		...
		add_settings_field('advanced_wordpress_configuration_plugin_correctTagForCustomTaxonomies', 
			__('Correct tags for custom taxonomies', 'advanced-wordpress-configuration-plugin-locale'), 
		...
		add_settings_field('advanced_wordpress_configuration_plugin_customUploadMimes', 
			__('Add more upload mimetypes', 'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_general', 
			'advanced_wordpress_configuration_plugin_general_section', 
		...
		add_settings_field('advanced_wordpress_configuration_plugin_disableAutoP', 
			__('Disable WP Auto P', 'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_general', 
			'advanced_wordpress_configuration_plugin_general_section', 
	...
	function addSettingsBackend() {
		...
		Profile page
		 */
		add_settings_field('advanced_wordpress_configuration_plugin_removeUserContactFields', 
			__('Remove user contact fields', 'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_backend', 
			'advanced_wordpress_configuration_plugin_backend_section_profile', 
		...
		Columns
		 */
		add_settings_field('advanced_wordpress_configuration_plugin_removePostColumns', 
			__('Remove posts backend columns', 'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_backend', 
			'advanced_wordpress_configuration_plugin_backend_section_columns', 
		...
		add_settings_field('advanced_wordpress_configuration_plugin_removePageColumns', 
			__('Removes pages backend columns', 
			'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 'advanced_wordpress_configuration_plugin_backend', 
			'advanced_wordpress_configuration_plugin_backend_section_columns', 
		...
		add_settings_field('advanced_wordpress_configuration_plugin_addPostThumbnailColumn', 
			__('Add post thumbnail column', 
			'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 'advanced_wordpress_configuration_plugin_backend', 
			'advanced_wordpress_configuration_plugin_backend_section_columns', 
		...
		add_settings_field('advanced_wordpress_configuration_plugin_addPageThumbnailColumn', 
			__('Add page thumbnail column', 'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_backend', 
			'advanced_wordpress_configuration_plugin_backend_section_columns', 
		...
		Dashboard
		 */
		add_settings_field('advanced_wordpress_configuration_plugin_customizeDashboardWidgets', 
			__('Customize dashboard widgets', 
			'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_backend', 
			'advanced_wordpress_configuration_plugin_backend_section_dashboard', 
		...
		add_settings_field('advanced_wordpress_configuration_plugin_disableDragDashboardWidgets', 
			__('Disable Widget dragging', 
			'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_backend', 
			'advanced_wordpress_configuration_plugin_backend_section_dashboard', 
	...
	function addSettingsFrontend() {
		...
		add_settings_field('advanced_wordpress_configuration_plugin_linkToLargeAttachementFile', __('Link to large version', 'advanced-wordpress-configuration-plugin-locale'), array($this, 'renderOptions'), 'advanced_wordpress_configuration_plugin_frontend', 'advanced_wordpress_configuration_plugin_frontend_section', 
			array( 'option_name' => 'advanced_wordpress_configuration_plugin_linkToLargeAttachementFile', 'type' => 'checkbox', 'label' => 'Links to the "large" version of an attached file/image, instead of the full version (e.g. for opening 6 megapixel images in lightboxes).' ) );

		add_settings_field('advanced_wordpress_configuration_plugin_wrapMoreInDiv', __('Wrap More-link in div', 'advanced-wordpress-configuration-plugin-locale'), array($this, 'renderOptions'), 'advanced_wordpress_configuration_plugin_frontend', 'advanced_wordpress_configuration_plugin_frontend_section', 
			array( 'option_name' => 'advanced_wordpress_configuration_plugin_wrapMoreInDiv', 'type' => 'checkbox', 'label' => 'Wraps the "more"-link in a div instead of a paragraph (e.g. for better positioning).' ) );


		/*
		Cleanup
		 */
		add_settings_field('advanced_wordpress_configuration_plugin_removeHeaderLinks', 
			__('Remove header data', 'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_frontend', 
			'advanced_wordpress_configuration_plugin_frontend_section_cleanup', 
		...
		add_settings_field('advanced_wordpress_configuration_plugin_removePingbackHeader', 
			__('Remove the pingback header', 'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_frontend', 
			'advanced_wordpress_configuration_plugin_frontend_section_cleanup', 
			array( 'option_name' => 'advanced_wordpress_configuration_plugin_removePingbackHeader', 'type' => 'checkbox' ) );

		add_settings_field('advanced_wordpress_configuration_plugin_removeWordpressVersion', 
			__('Remove Wordpress version', 'advanced-wordpress-configuration-plugin-locale'), 
			array($this, 'renderOptions'), 
			'advanced_wordpress_configuration_plugin_frontend', 
			'advanced_wordpress_configuration_plugin_frontend_section_cleanup', 
