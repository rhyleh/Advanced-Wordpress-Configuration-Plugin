<?php
/**
   * advanced-wordpress-configuration-pluginInit
   * methods for activating, deactivating the plugin
   *
   * @author     T. Boehning
   * @version	1
   */
...
if ( ! class_exists('advancedwordpressconfigurationpluginpluginInit' ) ) :
/**
 * This class triggers functions that run during activation/deactivation & uninstallation
 */
class advancedwordpressconfigurationpluginInit
{
    ...
    {
        new advancedwordpressconfigurationpluginInit( 'activate' );
    }
    ...
    function on_deactivate()
    {
        ...
        new advancedwordpressconfigurationpluginInit( $case );
    }
    ...
    function on_uninstall() {
        ...
        new advancedwordpressconfigurationpluginInit( 'uninstall' );
    }
    ...
    function activate_cb() {
        ...
        add_action( 'admin_notices', array($this, 'on_activation_note') );
    }
    ...
    function on_activation_note() {
        echo '<div class="updated "><p>Advanced Wordpress Configuration Plugin activated.</p> </div>';
    }
